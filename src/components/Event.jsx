      ...
      <div className="w-full px-4 py-8">
        <div className="flex flex-col lg:flex-row h-full">
          ...
          <div className="w-full lg:w-3/5 pr-0 lg:pr-8">
            <div className="mb-8">
              <h1 className="text-4xl font-bold text-indigo-400 mb-4">{event.eventName}</h1>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-300 text-lg">{event.organiserName}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-300 text-lg">{event.contact1}</p>
                  </div>
                </div>
                ...
                {event.contact2 && event.contact2 !== "Not specified" && (
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-300 text-lg">{event.contact2}</p>
                    </div>
                  </div>
                )}
                ...
                {event.organiserEmailId && event.organiserEmailId !== "Not specified" && (
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-300 text-lg">{event.organiserEmailId}</p>
                    </div>
                  </div>
                )}
              </div>
